...
1. **Create Failing Test Case**
   ...
   - Use the `super-agent-skills:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **super-agent-skills:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **super-agent-skills:verification-before-completion** - Verify fix worked before claiming success
